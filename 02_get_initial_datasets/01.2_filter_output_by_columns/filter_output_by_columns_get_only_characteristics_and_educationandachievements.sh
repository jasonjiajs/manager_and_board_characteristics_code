...
# Big commands to enter on terminal (for Step 2):
# sbatch filter_output_by_columns_get_only_characteristics_and_educationandachievements.sh filter_output_by_columns.py /project/kh_mercury_1/boardex/data/boardex_colstokeep/List_of_Variables_for_Boardex_and_Execucomp_310322.xlsx /project/kh_mercury_1/boardex/data/europe_smallfiles /project/kh_mercury_1/boardex/data/output_filtered_by_columns 1

# sbatch filter_output_by_columns_get_only_characteristics_and_educationandachievements.sh filter_output_by_columns.py /project/kh_mercury_1/boardex/data/boardex_colstokeep/List_of_Variables_for_Boardex_and_Execucomp_310322.xlsx /project/kh_mercury_1/boardex/data/na_smallfiles /project/kh_mercury_1/boardex/data/output_filtered_by_columns 1

# sbatch filter_output_by_columns_get_only_characteristics_and_educationandachievements.sh filter_output_by_columns.py /project/kh_mercury_1/boardex/data/boardex_colstokeep/List_of_Variables_for_Boardex_and_Execucomp_310322.xlsx /project/kh_mercury_1/boardex/data/row_smallfiles /project/kh_mercury_1/boardex/data/output_filtered_by_columns 1

# sbatch filter_output_by_columns_get_only_characteristics_and_educationandachievements.sh filter_output_by_columns.py /project/kh_mercury_1/boardex/data/boardex_colstokeep/List_of_Variables_for_Boardex_and_Execucomp_310322.xlsx /project/kh_mercury_1/boardex/data/uk_smallfiles /project/kh_mercury_1/boardex/data/output_filtered_by_columns 1
