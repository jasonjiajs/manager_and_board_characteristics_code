...
#SBATCH --job-name=filterdatabyrows
#SBATCH --output=out/filterdatabyrows%A-%a-%J.out 
...
srun python3 $program_path $SLURM_ARRAY_TASK_ID $SLURM_ARRAY_TASK_COUNT $input_dir $output_dir $companyid_listpath
